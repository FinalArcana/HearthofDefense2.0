...
public class UIHandler : MonoBehaviour {
  ...
  void InitializeFirebase() {
    ...
    app.SetEditorDatabaseUrl("https://gamedev-50e4c.firebaseio.com/");
    if (app.Options.DatabaseUrl != null) app.SetEditorDatabaseUrl(app.Options.DatabaseUrl);

    leaderBoard = new ArrayList();
    leaderBoard.Add("Firebase Top " + MaxScores.ToString() + " Scores");
    FirebaseDatabase.DefaultInstance
      .GetReference("account").OrderByChild("score")
      ...
      if (e2.Snapshot != null && e2.Snapshot.ChildrenCount > 0) {
        foreach (var childSnapshot in e2.Snapshot.Children) {
          if (childSnapshot.Child("score") == null
            ...
            leaderBoard.Insert(1, childSnapshot.Key.ToString() + " " + childSnapshot.Child("score").Value.ToString()
              + "  wins");
          }
        }
  ...
  void OnGUI() {
    ...
    if (Screen.width < Screen.height) {
      ...
      leaderBoardArea = new Rect(Screen.width * 0.1f, 0, Screen.width * 0.8f, Screen.height * 0.5f);
      logArea = new Rect(Screen.width * 0.5f, Screen.height * 0.5f, Screen.width * 0.5f, Screen.height * 0.5f);
    }
